...
export function ButtonsPage(pageName: number) {
    ...
    const Pagespath: string[] = ['https://velox-studios.vercel.app/jogos.html', 'https://velox-studios.vercel.app/suporte.html', 'https://velox-studios.vercel.app/novidades.html', 'https://velox-studios.vercel.app/kcbot.html', 'https://velox-studios.vercel.app']; //! Pages Names
