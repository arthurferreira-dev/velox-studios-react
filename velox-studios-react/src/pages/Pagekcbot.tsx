    ...
    return (
        <>
            ...
            <div id='background-body'>
                <main>
                    <img src={Images[0]} alt={Alt[0]} className='block m-auto mt-5 subElement' />
                    <h1 className='text-center text-white font-domine text-2xl mt-4 subElement'>KC Bot</h1>
                    <div id='text-div' className='bg-gray-800 text-white font-alan w-[80%] m-auto mt-4 border-top-left border-bottom-right p-3'>
                        ...
                        {CreatorBtn('Suporte do Bot', 'bg-yellow-500 block m-auto mt-4 duration-300 p-2 text-center rounded-md delay-1 hover:bg-amber-500 hover:cursor-pointer', HandleLinkBtn(Support))}
                    </div>
                </main>
            </div>
        </>
