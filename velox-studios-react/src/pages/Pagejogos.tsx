    ...
    return (
        <>
            ...
            <main className="w-[100%]">
                ...
                <img 
                    src={Images[3]} alt="aurasr.png"
                    width={wdtImg} loading='lazy'
                    className='m-auto block mt-3 rounded-md max-[501px]:rounded-none'
                />
                ...
                <img src={Images[2]} alt="aurasr.png" width={TwdtImg} loading='lazy' className='m-auto block mt-4'/>
                {CreatorBtn('Efeitos Sonoros', 'block m-auto mt-4 bg-green-500 p-3 text-white rounded-lg duration-300 hover:bg-green-600 hover:cursor-pointer', HandleLinkBtn(linkPath))}
            </main>
        </>
    );
}